...
5. If approved, Cloudflare forwards requests through a pre-established tunnel set up between Cloudflare and the homelab server
6. Request hits Cloudflare tunnel daemon `cloudflared` in the homelab
7. Daemon forwards request to nginx server at localhost
